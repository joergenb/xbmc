...
bool CSettings::LoadSettings(const CStdString& strSettingsFile)
{
  ...
  if (pElement)
  {
    ...
    int interlaceMethod;
    bool interlaceMethodPresent = GetInteger(pElement, "interlacemethod", interlaceMethod, VS_INTERLACEMETHOD_AUTO, VS_INTERLACEMETHOD_AUTO, VS_INTERLACEMETHOD_DXVA_ANY);
